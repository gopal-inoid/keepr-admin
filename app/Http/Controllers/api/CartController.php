...
class CartController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        if (!empty($user_details->id)) {
            ...
            if ($country_code == 'SA') {
                $saudiRates = array(
                    'SAUDI.REG' => ["service_name" => 'regular', 'service_code' => 'SAUDI.REG', 'is_tracking' => '0', 'shipping_rate' => floatval(14.00), "delivery_date" => "", "is_guanranted" => "0", "delivery_days" => "5-10"],
                    'SAUDI.EXP' => ["service_name" => 'express', 'service_code' => 'SAUDI.EXP', 'is_tracking' => '0', 'shipping_rate' => floatval(20.00), "delivery_date" => "", "is_guanranted" => "0", "delivery_days" => "3-5"]	
                );
