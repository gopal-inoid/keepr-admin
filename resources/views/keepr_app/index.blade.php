...
<body>
    ...
    <div class="Navbar-Section">
        <nav class="navbar container navbar-expand-lg navbar-light p-3 p-lg-0">
        ...
        <div class="container-fluid section_three" id="about">
            <div class="container">
                <div class="About_seocond row">
                    <div class="col-md-6">
                        <div class="rightMobileIcon2 d-flex align-items-center">
                    ...
                    <div class="step_section row">
                        ...
                        <div class="col-md-4 col-sm-12 steps row ms-2">
                            <div id="_block_1" class="col-lg-12 col-xl-9 col-sm-12 col-md-12 p-md-0">
                                ...
                                <p class=" mt-1">Once pairing is complete, you are all set! You will be alerted as soon
